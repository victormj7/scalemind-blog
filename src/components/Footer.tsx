...
export function Footer() {
  return (
    <footer className="bg-gray-950 text-gray-400 mt-20">
      {/* AdSense Footer — substitua pelo script do AdSense após aprovação */}
      <div className="max-w-6xl mx-auto px-4 py-3 border-b border-gray-800">
        <div className="h-16 flex items-center justify-center rounded-lg border border-dashed border-gray-700 text-xs text-gray-600 font-mono">
          {/* ADSENSE FOOTER: cole aqui o código da unidade de anúncio do rodapé */}
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2 font-bold text-lg text-white">
            <span className="w-7 h-7 rounded-md bg-gradient-to-br from-brand-500 to-accent-500 flex items-center justify-center text-white text-xs font-black">S</span>
            ScaleMind
          </div>
