...
export function CtaBox({
  ...
  if (variant === 'dark') {
    ...
    return (
      <div className="my-10 bg-gradient-to-br from-gray-900 to-sky-950 rounded-2xl p-8 text-center text-white">
        ...
        <h3 className="text-xl font-extrabold mb-3">{useCta.title}</h3>
        <p className="text-gray-300 text-sm mb-6 max-w-md mx-auto leading-relaxed">{useCta.subtitle}</p>
        <Link href={href}
  ...
  return (
    <div className="my-10 bg-gradient-to-br from-sky-50 to-violet-50 border-2 border-sky-200 rounded-2xl p-8 text-center">
      <p className="text-3xl mb-3">🚀</p>
      <h3 className="text-xl font-extrabold text-gray-900 mb-3">{useCta.title}</h3>
      <p className="text-gray-600 text-sm mb-6 max-w-md mx-auto leading-relaxed">{useCta.subtitle}</p>
      <Link href={href}
